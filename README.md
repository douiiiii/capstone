...
| 팀원 | 역할 | 주요 담당 |
|------|------|----------|
| **1번 (팀장)** | 프론트엔드 | 화면 설계 / 대시보드 UI / 지도 히트맵 / 매칭 결과 표시 |
| **2번** | 백엔드 (DB · 인프라) | Supabase 스키마 설계 / 마이그레이션 / API 통합 |
| **3번 (본인)** | 알고리즘 / 백엔드 (Logic) | 매칭 알고리즘 / 점수 체계 / 테스트 / ML 준비 |
| **4번** | 데이터 / QA | 더미 데이터 / 시나리오 검증 / 발표 자료 |

> 협업 문서:
> - [`docs/API_REFERENCE.md`](docs/API_REFERENCE.md) — 1번·2번 협업
> - [`docs/DATA_FORMAT.md`](docs/DATA_FORMAT.md) — 2번과의 데이터 형식 합의
> - [`docs/DEMO_GUIDE.md`](docs/DEMO_GUIDE.md) — 4번 발표 준비
